...
const TabsAccordions = () => {
  ...
  const accordianContent2: TabContentType[] = [
    ...
    },
    {
      ...
      text: "   Use our dedicated support email (support@Jyoti.com) to send your issues or feedback. We are here to help anytime",
    },
    {
      id: 4,
      title: "Will you regularly give updates of Bhanuni  ?",
      text: "Yes, We will update the Bhanuni  regularly. All the future updates would be available without any cost",
    },
  ];
