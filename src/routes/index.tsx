...
import BannerEdit from "../pages/apps/Ecommerce/BannerEdit";
import CollectionEdit from "../pages/apps/Ecommerce/collections";
import CategoriesEdit from "../pages/apps/Ecommerce/categories";
...
const ProductList = React.lazy(
  () => import("../pages/apps/Ecommerce/ProductList")
);
...
const ecommerceAppRoutes = {
  ...
  children: [
    ...
    {
      path: "/apps/ecommerce/edit-banner",
      name: "Banner Edit",
      element: <BannerEdit/>,
      route: PrivateRoute,
    },
    {
      path: "/apps/ecommerce/edit-Categories",
      name: "Categories Edit",
      element: <CategoriesEdit/>,
      route: PrivateRoute,
    },
    {
      path: "/apps/ecommerce/edit-collection",
